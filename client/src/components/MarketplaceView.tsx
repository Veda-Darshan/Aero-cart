...
import { Product, CartItem, Order, Feedback, Vendor, Rider } from "../types";
        ...
        <div className="p-6 space-y-6">
          ...
          <nav className="space-y-1">
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 text-xs font-bold uppercase tracking-wider transition-colors rounded-xl cursor-pointer glow-hover ${
            ...
            <button
                ...
                className={`w-full flex items-center justify-between px-4 py-3 text-xs font-bold uppercase tracking-wider transition-colors rounded-xl cursor-pointer glow-hover ${
                  activeMenu === "orders"
                    ? "bg-accent-primary text-white"
                    : "text-text-secondary hover:text-white hover:bg-canvas-secondary/5"
                }`}
                ...
                {filteredProducts.map((product) => {
                  ...
                  return (
                    <div key={product.id} className={`border border-border-subtle rounded-2xl p-4 flex flex-col justify-between group transition-all duration-200 hover:border-accent-primary hover:shadow-[0_0_24px_rgba(249,115,22,0.06)] relative overflow-hidden ${
                      isOutOfStock ? "sold-out" : "bg-canvas-secondary"
                    }`}>
                      ...
                      {/* Image */}
                      <div className="w-full h-48 bg-canvas-primary rounded-xl overflow-hidden mb-4 relative">
                        <img 
                          src={product.image} 
                          alt={product.name} 
                  ...
                  <div className="flex items-center gap-2">
                    <select
                      className="px-2 py-1 text-xs border border-border-subtle rounded"
